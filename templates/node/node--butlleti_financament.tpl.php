...
<div style="border: 1px solid #2f3031;">
	<table class="butlleti" style="font-family: Fira Sans,Helvetica,Arial,sans-serif; font-size: 13px; border:1px solid #53544F; border-bottom: 0px" width="910px" cellspacing="0px">
		...
		-->
		<tr style="background-color:#2f3031;"><td style="border-top: 0;">
		...
		<tr style="background-color:#2f3031; color:#878787; font-weight:bold;"><td style="padding: 5px 10px; border-top:3px solid #231f20; border-bottom: 0px solid white;">
			<?php
			$created = $node->created;
			echo $dies[date('N', $created)-1].', '.date('j', $created).' '.$mesos[date('n', $created)-1].' de '.date('Y', $created).' - Num. '.$title;
			?>
		</td><td style="text-align: right; padding: 5px 10px; border-top:3px solid #231f20; border-bottom: 0px solid white;">
			<a href="http://www.xarxanet.org/hemeroteca_financament" style=" color:#878787">Butlletins anteriors</a>
		</td></tr>

		<!-- NOTÍCIES PRINCIPALS -->
		<tr><td style="padding-top: 8px; width: 50%; border-top: 0;">
			<a href="<?php echo $noticia_prin_esq['link']?>" style="text-decoration:none">
				<img src="<?php echo $noticia_prin_esq['imatge']?>" alt="<?php echo $noticia_prin_esq['alt']?>" style="width: 100%;"/>
			</a>
		</td><td style="padding-top: 8px; width: 50%; border-top: 0;">
			<a href="<?php echo $noticia_prin_dreta['link']?>" style="text-decoration:none">
				<img src="<?php echo $noticia_prin_dreta['imatge']?>" alt="<?php echo $noticia_prin_dreta['alt']?>" style="width: 100%;"/>
			</a>
		</td></tr>
		...
		</td><td style="padding-left: 10px;  border-top: 0;">
		...
		<tr><td style="vertical-align: top; border-top: 0;">
			<p style="margin: 2px 0;"><?php echo $noticia_prin_esq['teaser']?></p>
		</td><td style="vertical-align: top; padding-left: 10px; border-top: 0;">
	...
	<table class="butlleti" style="font-family: Fira Sans,Helvetica,Arial,sans-serif; font-size: 13px; padding-top:15px; border:1px solid #53544F; border-top: 0px" width="910px" cellspacing="0px">
		<tr><td style="vertical-align:top; width: 75.4%; border-top: 0;">
			...
			<table class="butlleti" cellspacing="0px" style="margin-right: 15px; font-family: Fira Sans,Helvetica,Arial,sans-serif; font-size: 13px;" width="627px">
				...
				<?php foreach ($financ_nodes as $financ_node){?>
					<tr><td style="padding-top: 10px; width: 18px; vertical-align:top; border-top: 0;">
						<img src="<?php echo $pathroot;?>/sites/default/files/butlletins/financament/red_box.png" alt="punt vermell" width="18px"/>
					</td><td style="padding: 10px 0 5px 5px; border-top: 0;">
					...
					<tr><td colspan="2" style="border-top: 0;">
						<p style="margin: 0px;"><?php echo $financ_node['teaser']?></p>
						<p style="margin-top: 8px;"><strong>Convocant: </strong><?php echo $financ_node['convocant']?>
						<br/><strong>Termini: </strong><?php echo $financ_node['termini']?></p>
		...
		</td><td style="vertical-align:top; padding-right: 10px; padding-left: 6px; border-top: 0;">
			<table class="butlleti" cellspacing="0px" style="font-family: Fira Sans,Helvetica,Arial,sans-serif; font-size: 13px;">
				...
				<tr style="background-color:#CCCCCC; height: 35px;"><td style="padding: 0px 3px; border-bottom:solid white">
					<table class="butlleti" style="font-family: Fira Sans,Helvetica,Arial,sans-serif; font-size: 13px;"><tr><td style="vertical-align: middle;">
				...
				<?php foreach ($noticia_secundaria as $secundaria) { ?>
					<tr><td style="padding: 0px; border-top: 0 none;">
					<a style="text-decoration:none" href="<?php echo $secundaria['link']?>">
						<img alt="<?php echo $secundaria['alt']?>" src="<?php echo $secundaria['imatge']?>" style="margin-top: 15px; border: 0 none; margin-bottom: 8px;">
					</a></td style="padding: 0px; border-top: 0 none;"></tr>
					<tr><td style="padding: 0px; border-top: 0 none;">
